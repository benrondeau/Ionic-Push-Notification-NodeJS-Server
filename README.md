...
NodeJS server using [Ionic Push REST API](http://docs.ionic.io/push/send/) to send push notifications on iOS and Android. Based on ionic@1.4.0-alpha.6 release. Will return a promise which gives response with result having error field if its aan error
# Requirements
